...
대시보드 → **자산 구성**을 탭하면 열리는 화면입니다. 단순 조회를 넘어
...
![자산 구성 분석 — 요약 탭](../images/portfolio-analysis.svg)
...
- 심화 분석은 요약 지표만 AI에 전달하며 **개별 거래·계좌 정보는 보내지 않습니다**
  (자세한 원칙은 [AI 자산 점검](ai-review.md)).

## 집중도 · 국가 · 산업 · 배당

![자산 구성 분석 — 구성 탭](../images/analysis-composition.svg)

- **집중도** — 상위 1·5·10 종목 비중. 팔 수 있는 종목만 셉니다(현금·저축·부동산 제외).
...
- **목표 달성** — 설정에서 목표 자산(또는 FIRE 목표)을 넣으면 달성률과 예상 도달 시점을
...
- 실제 종목·수량 주문은 [자산배분 · 리밸런싱](allocation-rebalancing.md)에서 이어집니다.

## 알아두면 좋은 것

- 배당·국가·산업은 하루 한 번 종목 정보를 받아 캐시합니다. 앱을 처음 켜면 잠시 뒤 채워집니다.
- 모의투자 연동 계좌는 다른 화면과 마찬가지로 분석에서도 제외됩니다.
