...
1. **총 자산 · 현금 비중** — 시트 원장 기준 전체 자산과 현금성 자산 비율.
   모의투자 연동 계좌는 자산 계산에서 자동 제외됩니다(검증용 계좌가 실제 자산에 섞이지 않게).
2. **카테고리 구성** — 주식/ETF · 펀드 · 코인 · 현금 · 부동산 · 저축 · 채권별 비중 바.
3. **시장지표** — USD/KRW 환율, 미국 국채 2년·10년, 한국 국채 5년·10년, WTI·브렌트유.
   전용 새로고침 버튼으로 갱신하며, 일부 지표가 실패해도 성공한 지표만 갱신되고
   실패분은 마지막 정상값을 유지합니다.
